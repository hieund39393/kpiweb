...
function BoChiTieuTuDongHoa(props) {
  const {
    donViID,
    boChiTieuID,
    ngayBaoCao,
  ...
  return (
    <div
      ...
      id="boChiTieuTuDongHoa"
    >
      <div className="bct-data__title">
        <h3>Bộ chỉ tiêu tự động hóa</h3>
      </div>
      <Charts
        boChiTieuDisplayID="Bộ chỉ tiêu tự động hóa"
        donViID={donViID}
...
export default BoChiTieuTuDongHoa;
