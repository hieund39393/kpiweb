...
function BoChiTieuTruyenThong(props) {
  const {
    donViID,
    boChiTieuID,
    ngayBaoCao,
  ...
  return (
    <div
      ...
      id="boChiTieuTruyenThong"
    >
      <div className="bct-data__title">
        <h3>Bộ chỉ tiêu truyền thông</h3>
      </div>
      <Charts
        boChiTieuDisplayID="Bộ chỉ tiêu truyền thông"
        donViID={donViID}
...
export default BoChiTieuTruyenThong;
