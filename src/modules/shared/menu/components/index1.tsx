...
const SideBar = () => {
  ...
  const getChucNangCon = () => {
    const data = httpService.get(GET_CN_CON, null);
  ...
  return (
    <Router>
      <Layout className={name + ' ' + fixContent}>
        ...
        >
          <div className='layout-page-content page-layout-content'>
            <div className='page-content-title'>Nhóm chỉ tiêu kỹ thuật</div>
            <div>
              <select name="cars" id="cars">
                <option onClick={handlerClickOption} value="volvo">Volvo</option>
