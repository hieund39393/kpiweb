  ...
  function () {
    ...
    async function _listAsync({ data, pageIndex, pageSize }) {
      ...
      if (data.loaiChiTieuID === 'null') {
        if (data.thang === null) {
          url = route.list + "?DonViID=" + data.donViID + '&nam=' + data.nam + '&LoaiBaoCao=' + data.loaiBaoCao + '&PageIndex=' + pageIndex + "&PageSize=" + pageSize;
        } else url = route.list + "?DonViID=" + data.donViID + '&Thang=' + data.thang + '&nam=' + data.nam + '&LoaiBaoCao=' + data.loaiBaoCao + '&PageIndex=' + pageIndex + "&PageSize=" + pageSize;
      } else {
        if (data.thang === null) {
          url = route.list + "?DonViID=" + data.donViID + '&LoaiChiTieuID=' + data.loaiChiTieuID + '&LoaiBaoCao=' + data.loaiBaoCao + '&nam=' + data.nam + '&PageIndex=' + pageIndex + "&PageSize=" + pageSize;
        } else url = route.list + "?DonViID=" + data.donViID + '&LoaiChiTieuID=' + data.loaiChiTieuID + '&LoaiBaoCao=' + data.loaiBaoCao + '&Thang=' + data.thang + '&nam=' + data.nam + '&PageIndex=' + pageIndex + "&PageSize=" + pageSize;
      }
