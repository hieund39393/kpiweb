    ...
    if (getField.tenCauHinh.indexOf(_DAILY) > -1) {
      return (
        ...
        >
          ...
          >
            <Input type="number" placeholder="Nhập giờ " ref={this.inputRef} />
          </Form.Item>
          <Form.Item
            label="Phút "
            name="phut"
      ...
      return (
        ...
        >
          <Form.Item
            ...
            rules={[{ pattern: /^[0-9]\d*$/, message: 'Không được nhập số âm' }]}
          >
            <Input type="number" placeholder="Nhập ngày " ref={this.inputRef} />
          </Form.Item>
          <Form.Item
            label="Giờ"
            name="gio"
      ...
      >
        <Form.Item
          ...
          rules={[{ pattern: /^[0-9]\d*$/, message: 'Không được nhập số âm' }]}
        >
          <Input type="number" placeholder="Nhập phút" ref={this.inputRef} />
        </Form.Item>
        <Form.Item
          label="Mô tả"
          name="moTa"
